...
namespace HelloWorld.ServiceReference1.Activities {
...
partial void AfterInitializeComponent();
        ...
        private string FindResource() {
            ...
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                ...
                if ((resource.Contains(".HelloWorld.ServiceReference1.UpperOperatorPortType.upper.g.xaml") || resource.Equals("HelloWorld.ServiceReference1.UpperOperatorPortType.upper.g.xaml"))) {
                    return resource;
                }
            }
